...
output_dir = dir + File.separator + "GFP+ area CSV" + File.separator;
output_dir2 = dir + File.separator + "GFP+ ROI" + File.separator;
...
for (i = 0; i < lengthOf(fileList); i ++) {
	...
	if (!File.isDirectory(current_imagePath)){
		...
		run("Analyze Particles...", "size=175-Infinity circularity=0.00-0.60 clear add");
