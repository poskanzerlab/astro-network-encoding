function PlotTSMean_PreVPost_ChooseStat( TS_mean_preVpost, TS_idx, TITLE, YLABEL, YLIMS, stdOrsem, STAT )
...
%   STAT: 'parametric' or 'nonparametric' to determine which stats to use
...
elseif strcmp(STAT, 'nonparametric')
    p_val = signrank(TS_mean_preVpost(TS_idx,1), TS_mean_preVpost(TS_idx,2)); %Wilcoxon signed rank test
end
hold on
